...
namespace Empty
{
    public class Set : Operation<(Result,Qubit), QVoid>, ICallable
    {
        ...
        String ICallable.FullName => "Empty.Set";
        ...
        {
            var (desired,q1) = __in;
#line 19 "/Users/bhagvan.kommadi/Desktop/packt/Q#Book/Code/Chapter2/Q#Constructs/Empty/Quantum.qs"
            var current = M.Apply(q1);
#line 20 "/Users/bhagvan.kommadi/Desktop/packt/Q#Book/Code/Chapter2/Q#Constructs/Empty/Quantum.qs"
            if ((desired != current))
            {
#line 22 "/Users/bhagvan.kommadi/Desktop/packt/Q#Book/Code/Chapter2/Q#Constructs/Empty/Quantum.qs"
