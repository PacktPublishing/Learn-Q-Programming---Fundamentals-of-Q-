...
namespace IfElse
{
    public class Set : Operation<(Result,Qubit), QVoid>, ICallable
    {
        ...
        String ICallable.FullName => "IfElse.Set";
        ...
        {
            var (desired,q1) = __in;
#line 19 "/Users/bhagvan.kommadi/Desktop/packt/Q#Book/Code/Chapter2/Q#Constructs/IfElse/Quantum.qs"
            var current = M.Apply(q1);
#line 20 "/Users/bhagvan.kommadi/Desktop/packt/Q#Book/Code/Chapter2/Q#Constructs/IfElse/Quantum.qs"
            if ((desired != current))
            {
#line 22 "/Users/bhagvan.kommadi/Desktop/packt/Q#Book/Code/Chapter2/Q#Constructs/IfElse/Quantum.qs"
